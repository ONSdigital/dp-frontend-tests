Feature: Delete Content
  ...
  Scenario: Delete content should be removed from search indexes
    ...
    When I search for "xRtv2E6" in the ONS Website
    Then there should not be any search results related to "xRtv2E6" page
    ...
    When I search for "xRtv2E6" in the ONS Website
    Then there should be a search result related to "xRtv2E6" page
