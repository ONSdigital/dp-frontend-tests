...
Feature: Tests to check chart builder
  ...
  Scenario: Test to create a BAR Chart, verify in preview and in Website
    ...
    Then I review the files awaiting review with data-url:businessindustryandtrade/business/activitysizeandlocation/bulletins/random page
    ...
    Then the ONS website does contain the new chart details
