...
////
////    }
//    // use our base page to send data into the field
//
...
////        WebElement table = getD.findElement(By.cssSelector(mappedElement));
...
////        String titleText = .findElement(By.xpath(mappedElement)).getText();
